...
public class GameManager : MonoBehaviour
{
    ...
    void InitGame()
    {
        ...
        niveles = new List<Nivel>()
        {
            ...
            new Nivel(0,"Level 4","Niagara Falls",false,0,false,120,50),
            ...
            new Nivel(4,"Level 4","Niagara Falls",false,0,true,120,8),
            new Nivel(5,"Level 5","Third time lucky",false,0,true,60,8),
